<template>
    <div class="container-fluid">
        ...
        <div class="mt-4 d-flex justify-content-between">
            <button :disabled="!articles.prev_page_url" @click="getArticles(articles.prev_page_url)" class="btn btn-warning">Prev Page</button>
            <button :disabled="!articles.next_page_url" @click="getArticles(articles.next_page_url)" class="btn btn-warning">Next Page</button>
        </div>
